        ...
        <footer className="border-t py-12">
            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
                ...
                <div>
                    ...
                    <form className='flex'>
                        <input type="email" placeholder="Enter your email" className="p-3 w-full text-sm border-t border-l border-bborder-gray-300 rounded-1-md focus: outline-none focus: ring-2 focus: ring-gray-500 transition-all" required />
            ...
            <div className="container mx-auto mt-12 px-4 lg:px-0 border-tborder-gray-200 pt-6">
